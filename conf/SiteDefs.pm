...
<<<<<<< Updated upstream
  $SiteDefs::ENSEMBL_RELEASE_DATE     = '6 December 2023';
  $SiteDefs::RAPID_RELEASE_VERSION    = 56;
=======
  $SiteDefs::ENSEMBL_RELEASE_DATE     = '24 January 2024';
  $SiteDefs::RAPID_RELEASE_VERSION    = 57;
>>>>>>> Stashed changes
  $SiteDefs::HAS_ANNOTATION           = 1;
  $SiteDefs::NO_REGULATION            = 1;
  $SiteDefs::NO_VARIATION             = 0;
  $SiteDefs::VCF_VARIANTS_ONLY        = 1;
